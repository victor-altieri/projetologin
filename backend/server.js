...
//MIDDLEWARE QUE VAI PROTEGER AS ROTAS DA API E GARANTIR QUR APENAS USUARIOS
//COM UM TOKEN VALIDO POSSAM ACESSAR

const autenticaToken = ()=>{
    const auth = req.headers['authorizaion'];
